                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a href="librarian_home.php"><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                            ...
                            <li><a href="issued_books.php"><i class="fa fa-bar-chart-o"></i> Issued Books <span
                                    class="fa fa-chevron-down"></span></a>

                            </li>
                            <li><a href="send_message.php"><i class="fa fa-edit"></i> Send Message<span class="fa fa-chevron-down"></span></a>
